                ...
                client.on('ready', async () => {
                    ...
                    async function send_schedule_message() {
                        ...
                        if (get_cron_compose_result.length > 0) {
                            ...
                            //                             const minute = currentDateTime.minutes();
                            //                             const hour = currentDateTime.hours();
                            //                             const dayOfMonth = currentDateTime.date();
                            //                             const month = currentDateTime.month() + 1; // Month in Moment.js is 0-indexed
                            //                             const dayOfWeek = currentDateTime.day(); // 0 represents Sunday, 1 represents Monday, and so on
