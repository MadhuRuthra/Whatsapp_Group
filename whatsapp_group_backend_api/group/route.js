                    ...
                    async function send_message() {
                        ...
                        client.getChats().then(async (chats) => {
                            try {
                                ...
                                const update_active = `UPDATE cron_compose SET cron_status = '${res_status}' WHERE user_id = '${user_id}' AND cron_status != 'Y' and com_msg_media_id = '${insert_msg_content_result.insertId}' `
