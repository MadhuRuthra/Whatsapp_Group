                ...
                async function send_message() {
                    ...
                    client.getChats().then(async (chats) => {
                        try {
                            ...
                            const insert_msg_content = `INSERT INTO whatsapp_group_newapi_${user_id}.compose_msg_media_${user_id} VALUES(NULL,'${insert_msg_result.insertId}','${message_content}',NULL,NULL,NULL,NULL,NULL,NULL,'N',CURRENT_TIMESTAMP)`
