...
--
-- Host: localhost
-- Generation Time: Feb 12, 2024 at 03:03 PM
...
(32, 1, 1, 'YEEJAI', 4, 3, 0, 'Y', 'Y', '2024-02-09 05:57:58', '2024-02-12 13:12:22', 'https://chat.whatsapp.com/Dh7gPIUaCfMHhoAyoRU1lR', '/opt/lampp/htdocs/whatsapp_group_newapi/uploads/group_qr/YEEJAI.png', 1, 3);
...
(1, 2, 1, 200, 134, 66, 30, 2, 28, 600, 600, 0, 'Y', '2024-02-12 13:08:18', '2024-02-11 19:01:48'),
...
(1, 1, 1, 'Super Admin', 'AA1DE999B6B65D2', 'e58a3754522a05c1ff4d231f8e8cc1bd', 'super_admin@gmail.com', '9000090000', 'Y', '2021-12-30 06:22:20', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3MDc3NDIyMzksImV4cCI6MTcwODM0NzAzOX0.oWVJIffQmcDyP5juCcUlva1jk7SO61iAk4yM52plUOE'),
...
--
ALTER TABLE `api_log`
  MODIFY `api_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1030;
...
--
ALTER TABLE `group_contacts`
  MODIFY `group_contacts_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `user_log`
  MODIFY `user_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=286;
