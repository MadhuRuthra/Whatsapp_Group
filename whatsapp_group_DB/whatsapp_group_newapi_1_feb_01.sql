...
--
ALTER TABLE `compose_message_1`
  MODIFY `compose_message_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT for table `compose_msg_media_1`
--
ALTER TABLE `compose_msg_media_1`
  MODIFY `compose_msg_media_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
COMMIT;
