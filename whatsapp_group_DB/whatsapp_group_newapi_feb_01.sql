...
--
-- Host: localhost
-- Generation Time: Feb 01, 2024 at 03:19 PM
...
(8, 112, 110, 1, 0, 'Y', '2024-02-01 10:56:21', NULL),
...
(3, 1, 2, 'ca_Demo_026_3', '919965014814', '919965014814', 'Success', 'Y', '2024-01-26 01:33:57', NULL),
(4, 1, 2, 'ca_Demo_026_4', '916369841530', '916369841530', 'Success', 'Y', '2024-01-26 01:36:01', NULL),
(5, 1, 2, 'ca_Demo_026_5', '919150794800', '919150794800', 'Success', 'Y', '2024-01-26 01:36:59', NULL);
...
(1, 1, 1, 'TESTING', 2, 2, 0, 'Y', 'Y', '2024-01-23 08:02:57'),
(2, 1, 1, 'Demo', 3, 3, 0, 'Y', 'Y', '2024-01-26 01:33:57');
...
(1, 2, 1, 200, 187, 13, 30, 28, 2, 600, 600, 0, 'Y', '2024-02-01 11:01:27', '2024-02-11 19:01:48'),
...
(1, 1, '918838964597', 'test', 'http://localhost/whatsapp_group_newapi/uploads/whatsapp_images/1_1706770374351.png', 'Y', '2024-02-01 06:53:02', '0000-00-00 00:00:00');
...
(1, 1, 1, 'Super Admin', 'AA1DE999B6B65D2', 'e58a3754522a05c1ff4d231f8e8cc1bd', 'super_admin@gmail.com', '9000090000', 'Y', '2021-12-30 06:22:20', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3MDY3OTIyMTEsImV4cCI6MTcwNzM5NzAxMX0.MBb1JMOjHWS3Dbuw1fHxGm14AXj9SJuA-t_0X7crb5c'),
...
--
ALTER TABLE `api_log`
  MODIFY `api_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=698;

--
-- AUTO_INCREMENT for table `cron_compose`
--
ALTER TABLE `cron_compose`
  MODIFY `cron_com_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `group_contacts`
--
ALTER TABLE `group_contacts`
  MODIFY `group_contacts_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `group_master`
--
ALTER TABLE `group_master`
  MODIFY `group_master_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `template_master`
  MODIFY `template_master_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `user_log`
--
ALTER TABLE `user_log`
  MODIFY `user_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=269;
