...
--
-- Host: localhost
-- Generation Time: Jan 11, 2024 at 02:45 PM
...
(1, 2, 1, 200, 200, 0, 30, 30, 0, 600, 600, 0, 'Y', '2024-01-11 14:44:42', '2024-02-11 19:01:48');
...
(36, 2, '918838964597', 'test', '2_1704535484920.png', 'Y', '2024-01-06 10:04:58', '0000-00-00 00:00:00'),
...
(2, 2, 1, 'User 1', '2134D2287A57625', 'e58a3754522a05c1ff4d231f8e8cc1bd', 'user_1@gmail.com', '9000090001', 'Y', '2023-03-01 02:20:45', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3MDQ5ODEwODgsImV4cCI6MTcwNTU4NTg4OH0.OgYwLYzprKHmWGQvPZN9rVgnYoJqM_NvGJAHLF-echI'),
...
--
ALTER TABLE `api_log`
  MODIFY `api_log_id` int NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=107;
--
...
--
ALTER TABLE `senderid_master`
  MODIFY `sender_master_id` int NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=41;
--
...
--
ALTER TABLE `user_log`
  MODIFY `user_log_id` int NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=236;
--
