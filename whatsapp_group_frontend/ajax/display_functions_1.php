                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="add_contact_group?group=<?= $sms->group_list[$indicator]->group_master_id ?>&sender=<?= $sms->group_list[$indicator]->mobile_no ?>"
                                                                class="btn btn-primary"><i class="fas fa-edit"></i> Update Contacts</a> <button
                                                                type="button" title="Remove Users"
                                                                onclick="remove_users_popup( '<?= $sms->group_list[$indicator]->group_master_id ?>', '<?= $indicatori ?>','<?= $sms->group_list[$indicator]->group_name ?>','<?= $sms->group_list[$indicator]->mobile_no ?>','<?= $sms->group_list[$indicator]->user_id ?>')"
                                                                class="btn btn-icon btn-danger" style="padding: 0.3rem 0.41rem !important;">Remove
                                                                Users</button>
                                                        </td>
                                ...
                                <table style="width: 100%;">
                                    ...
                                    for ($indicator = 0; $indicator < count($contact_list); $indicator++) {
                                          if ($indicator % 2 == 0) { ?>
                                                    ...
                                                    <?php } ?>
                                                    <td>
                                                        <input type="checkbox" <?php if ($contact_list[$indicator]->mobile_no) { ?><?php } ?>
