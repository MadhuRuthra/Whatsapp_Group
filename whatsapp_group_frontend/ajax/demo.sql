vBEGIN
    ...
    SET @query = CONCAT(
        ...
        WHERE cmp.campaign_name = "', campaign_name, '" AND cmp.cm_status = "P" and sts.sender_mobile_no IS NOT NULL'
    );
    ...
    -- If sender_mobiles is NULL or empty, return an empty array
     IF @sender_mobiles IS NULL OR LENGTH(@sender_mobiles) = 0 THEN
