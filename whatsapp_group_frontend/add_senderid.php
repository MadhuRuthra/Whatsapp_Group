                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item active"><a href="whatsapp_no_api_list">Manage Sender ID List</a>
                            </div>
                    ...
                    <div class="section-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8 col-lg-8 offset-2">
                                <div class="card">
                                    <form class="needs-validation" novalidate="" id="frm_store" name="frm_store"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group mb-2 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select id="txt_country_code" name="txt_country_code"
                              ...
                              for ($indicator = 0; $indicator < count($state1->country_list); $indicator++) {
                                ...
                                ?>
                                                        <option value="<?= $countryid . "~~" . $phonecode ?>" <? if
                                                            ($shortname=='IN' ) { echo "selected" ; }else{
                                                            echo "disabled" ; } ?>><?=
                            ...
                            ?>
                                            ...
                                            <div class="form-group mb-2 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="mobile_number" id='mobile_number'
                                                        class="form-control" value="<?= $_REQUEST['mob'] ?>"
                                                        tabindex="1" required="" maxlength="10"
                                                        placeholder="Mobile Number" data-toggle="tooltip"
                                                        data-placement="top" title=""
                                                        data-original-title="Mobile Number"
                                                        onkeypress="return validateInput(event)" <? if ($_REQUEST['mob']
                                                        !='' ) { ?> readonly
                                                    <? } ?>>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-2 row">
                                                <label class="col-sm-3 col-form-label">Profile Name <label
                                                        style="color:#FF0000">*</label></label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="txt_display_name" id='txt_display_name'
                                                        class="form-control" tabindex="2" required="" maxlength="30"
                                                        value="<?= $_REQUEST['pro'] ?>" <? if ($_REQUEST['pro'] !='' ) {
                                                        ?> readonly
                                                    <? } ?> onkeypress="return clsAlphaNoOnly(event)"
                                                    placeholder="Profile Name" data-toggle="tooltip"
                                                    data-placement="top" title=""
...
$_SESSION['img_name'] = $_REQUEST['img'] ;
                         echo "<img src='" . $_REQUEST['img'] . "' style='width:100px; max-height: 100px;'>";
                                                    ...
                                                    <input type="file" class="form-control" name="fle_display_logo"
                                                        id='fle_display_logo' tabindex="3"
                                                        accept="image/png, image/jpg, image/jpeg" required=""
                                                        data-toggle="tooltip" data-placement="top" title="" <? if
                                                        ($_REQUEST['img'] !='' ) { ?> style="display: none"
                                                    <? } ?>
                                                    data-original-title="Profile Image - Allowed only jpg, png images.
                                                    Maximum 2 MB Size allowed">
                                                </div>
                                            </div>
                        ...
                        <div class="col-sm-9">
                          ...
                          value='save_mobile_api' />--->
                                    <input type="submit" name="compose_submit" id="compose_submit" tabindex="5"
                                        value="Submit" class="btn btn-success">

                                    <div class="container">
                                        <span class="error_display" style='font-size: 12px;'
                                            id='qrcode_display'></span><Br>
