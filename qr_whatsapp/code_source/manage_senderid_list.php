...
<div class="loading" style="display:none;">Loading&#8230;</div>
          ...
          <!-- <div class="row">
            <div class="col-12">
              <a href="#!" class="btn btn-outline-success btn-disabled" title="Active" style="width:100px;">Active</a>&nbsp;<a href="#!"
                ...
                class="btn btn-outline-danger btn-disabled" title="Inactive" style="width:100px;">Inactive</a>&nbsp;<a href="#!"
                class="btn btn-outline-warning btn-disabled" title="Invalid" style="width:100px;">Invalid</a>&nbsp;<a href="#!"
                class="btn btn-outline-danger btn-disabled" title="Mobile No Mismatch" style="width:100px;">Mobile No Mismatch</a>&nbsp;<a
                href="#!" class="btn btn-outline-info btn-disabled" title="Processing" style="width:100px;">Processing</a>&nbsp;<a href="#!"
                class="btn btn-outline-danger btn-disabled" title="Rejected" style="width:100px;">Rejected</a>&nbsp;<a href="#!"
                class="btn btn-outline-primary btn-disabled" title="Need Rescan" style="width:100px;">Need Rescan</a>&nbsp;<a href="#!"
                class="btn btn-outline-info btn-disabled" title="Linked" style="width:100px;">Linked</a>&nbsp;<a href="#!"
                class="btn btn-outline-warning btn-disabled" title="Unlinked" style="width:100px;">Unlinked</a>
            </div>
          </div> -->
  ...
  <script>
    ...
    var whatspp_config_ids, approvestatus, indicatoris;
    //popup function
    function remove_senderid_popup(whatspp_config_id, approve_status, indicatori) {
      whatspp_config_ids = whatspp_config_id; approvestatus = approve_status; indicatoris = indicatori;
