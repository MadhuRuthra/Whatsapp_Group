...
<head>
  ...
  <title>Campaign Report :: <?= $site_title ?></title>
...
<body>
        ...
        <section class="section">
          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Campaign Report</div>
            </div>
          </div>
          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <div class="table-responsive" id="id_campaign_report"> <!-- List from API -->
                      Loading ..
                    </div>
                  </div>
                </div>
  ...
  <script>
    ...
    function campaign_report() {
      $.ajax({
        type: 'post',
        url: "ajax/display_functions.php?call_function=campaign_report",
        dataType: 'html',
